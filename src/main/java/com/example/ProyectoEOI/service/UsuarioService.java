...
public class UsuarioService {
    ...
    public UsuarioDTO login(UsuarioDTO usuarioDto) throws UsuarioException{
        Optional<Usuario> optionalUsuario = this.repository.findByEmail(usuarioDto.getEmail());

        if (optionalUsuario.isEmpty()) {
            throw new UsuarioException("No se ha encontrado ningun usuario con el email %s".formatted(usuarioDto.getEmail()));
        }
